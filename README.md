...
<div align="center">
  ...
  <a href="https://x.com/abusufiyan1902" target="_blank">
...
- 🌱 Exploring **ERPNext, Frappe customization & scalable architectures**
- 🤝 Open to collaborate on **Frappe, ERPNext & Django** projects
- 💬 Ask me about **Python, Django, Frappe, MySQL & REST APIs**
- ⚡ I love building software that solves real business problems
...
| ❤️ | **Heart Disease Prediction** | ML model predicting heart disease risk from medical parameters | `Python` `Pandas` `Scikit-Learn` | [🔗 Live](https://heartdiseaseprediction-9jhy9az7op6p4kozvgsd2n.streamlit.app/) |
| 🏠 | **House Price Prediction** | ML model predicting property prices from housing features | `Python` `Pandas` `Scikit-Learn` | [🔗 Live](https://housepredictionappapp-pb5lnuuc6sujjkamqvpttq.streamlit.app/) |
...
| 🥇 | Oracle Cloud Data Management Certified Foundations Associate | Oracle |
